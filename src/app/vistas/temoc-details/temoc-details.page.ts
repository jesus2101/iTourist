...
@Component({
  selector: 'app-temoc-details',
  templateUrl: './temoc-details.page.html',
  styleUrls: ['./temoc-details.page.scss'],
})
export class TemocDetailsPage implements OnInit,OnDestroy{
  images11:string[]=[];
 ...
 map: leaflet;
  ...
  constructor(private geolocation: Geolocation, private browser: InAppBrowser,private route:ActivatedRoute, private nav:NavController, private temocService: TemocService, private loadingController:LoadingController,private viewer:PhotoViewer) { }
  ...
  loadTodo(){
   ...
   this.temocService.getTodo(this.todoId).subscribe(res=>{
