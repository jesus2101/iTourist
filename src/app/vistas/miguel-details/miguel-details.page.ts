...
@Component({
  selector: 'app-miguel-details', 
  templateUrl: './miguel-details.page.html',
  styleUrls: ['./miguel-details.page.scss'],
})
export class MiguelDetailsPage implements OnInit,OnDestroy {
  images11:string[]=[];
  ...
  constructor(private geolocation: Geolocation, private browser: InAppBrowser,private route:ActivatedRoute, private nav:NavController, private migueService: MiguelService, private loadingController:LoadingController,private viewer:PhotoViewer) { }
  ...
  loadTodo(){
   ...
   this.migueService.getTodo(this.todoId).subscribe(res=>{
